...
public class UserServiceImpl implements UserService {
	...
	public boolean registerUser(User user) throws UserAlreadyExistException {
		...
		if(userDAO.getUserById(user.getUserId())==null) {
			...
			operationFlag = userDAO.registerUser(user);
			
		}else {
			
			throw new UserAlreadyExistException("User record already present");
	...
	public User updateUser(User user, String userId) throws Exception {
		...
		User userRecord = userDAO.getUserById(userId);
	...
	public boolean validateUser(String userId, String password) throws UserNotFoundException {
		...
		boolean operationFlag = userDAO.validateUser(userId, password);
