...
public class Reminder {
	 ...
	 * reminderCreatedBy,reminderCreationDate,notes). Out of these seven fields,
	 * the field reminderId should be primary key and auto-generated. This class
	 * should also contain the getters and setters for the fields along with the
	 * no-arg , parameterized constructor and toString method. The value of
	 * reminderCreationDate should not be accepted from the user but should be
	 * always initialized with the system date. annotate notes field
	 * with @OneToMany and @JsonIgnore
	 */
